...
public class BankClient extends Session{
	...
	public BankClient(int TCPport){
		...
		try {
			...
			logger.error("JAXBException Exception: Class:BankClient constructor");
			e.printStackTrace();
		}
	}
	...
	public TransactionMessageBean getRequest(){
		...
		try {
			...
			logger.error("JAXBException Exception: Class:BankClient getRequest");
			e.printStackTrace();
		}
	...
	public void sendResponse(TransactionMessageBean response){
		...
		try {
			...
			logger.error("JAXBException Exception: Class:BankClient sendResponse");
