...
<body>
	...
	<!-- /.navbar -->
	<div class="jumbotron" style="background-color: #dff0d8; border-color: #d6e9c6; ">
		<h1>Deposit</h1>
		<p class="lead" style="text-align: center;">Deposit funds to your account and have immediate
			access to your money!</p>
		
	</div>
	<div class="container">
	<form method="POST" action="Deposit.do">
	<div class="bs-example bs-example-form" autocomplete="off" method="POST" >
			...
			<div class="panel panel-success">
				...
				<div class="input-group-lg">
					<span class="input-group-addon">$</span> <input type="text"
						class="form-control" name="txtAmount">
				</div>
			</div>
			<div row>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header" style="text-align: center;background-color: #dff0d8;">
            ...
            <h4 class="modal-title" id="myModalLabel">Confirm Deposit</h4>
            <img src="images/deposit.jpg" width="100px"/>
          </div>
          <div class="modal-body">
           Do you wish to confirm deposit?
           (Click Confirm Deposit to proceed/Click close to return to deposit screen)
          </div>
          <div class="modal-footer" style="background-color: #dff0d8;">
            <button class="btn btn-default" type="button" data-dismiss="modal">Close</button>
            <button class="btn btn-primary" type="submit">Confirm Deposit</button>
          </div>
